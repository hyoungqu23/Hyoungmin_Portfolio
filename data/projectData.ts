...
const projects: Projects[] = [
  {
    ...
    descriptions: [
      ...
      {
        tag: 'feature',
        content: '모바일 뷰를 고려해 Tailwind CSS를 활용하여 반응형 디자인을 구현했습니다.',
      },
    ],
    retrospective:
  ...
  },
  {
    ...
    descriptions: [
      {
        tag: 'feature',
        content:
          '로그인 시 사용자의 편의를 높이기 위해 로그인 만료 메시지 및 로그인 폼의 validation 기준 미충족시 경고 메시지 등을 구현했습니다.',
      },
      {
        tag: 'UI/UX',
        content:
    ...
    retrospective:
      '로그인 validation, 로그인 상태에 따른 페이지 라우팅 등의 로그인 기능을 구현하면서 인증/인가에 대해 이해할 수 있었고, 어떻게 하면 UX를 향상시킬 수 있을 지에 대해 고민하면서 기본적인 상세 페이지 UI를 구현했습니다. 자세한 회고는 아래 링크에서 보실 수 있습니다.',
  },
  {
    title: '댓글 기능 프로젝트',
    ...
    descriptions: [
      {
        tag: 'refactoring',
        content:
          'Redux-Toolkit의 반복되는 ExtraReducers 코드를 제거하고자 extraReducerUtils를 고민하며 직접 구현해봤습니다.',
      },
      {
        tag: 'refactoring',
        content:
    ...
    descriptions: [
      {
        tag: 'UI/UX',
        content:
          '상품이 많아질수록 목록 렌더링 시간이 길어지므로, 페이지네이션 로직을 직접 구현하여 사용자의 대기 시간을 줄이고자 했습니다.',
      },
      {
        tag: 'UI/UX',
        content:
          '상품의 제목과 설명이 줄바꿈이 되어 UI를 해치는 등의 기존 웹 사이트의 문제와 이미지 크기를 통일해 UI를 개선하고자 했습니다.',
      },
    ],
    retrospective:
      '특정 로직을 처음부터 뜯어보며 구현하는 것이 조금 더 깊게 이해하는데 도움을 준다는 것을 느끼고, UI/UX에 대해서 고민하게 만든 프로젝트입니다. 자세한 회고는 아래 링크에서 보실 수 있습니다.',
  },
  {
    title: 'CFD',
  ...
  },
  {
    ...
    retrospective:
      '비동기적으로 협업하는 방식을 체득하고, 기본적인 웹 스토어의 기능을 구현하면서 재미있는 시간을 보낸 프로젝트입니다. 추가적으로 JavaScript로 진행하면서 React와 Next.js의 필요성을 느꼈습니다. 자세한 회고는 아래 링크에서 보실 수 있습니다.',
  },
];
